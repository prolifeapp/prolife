package br.com.prolife.interceptor;
...
import br.com.prolife.service.UserService;
import br.com.prolife.util.BasicAuthUtil;
...
public class SecurityInterceptor implements ContainerRequestFilter{
	...
	public void filter(ContainerRequestContext containerRequest) throws IOException {
		...
		if(path.equals("/user/register") ||
				path.equals("/login") || 
				path.equals("/login/retrieve-password") || 
				path.equals("/login/redefine-password") || 
